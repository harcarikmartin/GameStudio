...
public class RatingJpaSimple implements RatingService{
	...
	public int findRatingsCountForGame(String gameName) {
		return Integer.parseInt( JpaHelper.getEntityManager().createQuery("Select count(r.gameName) from RatingJ r where r.gameName = :gameName").setParameter("gameName", gameName).getSingleResult().toString());
	}
